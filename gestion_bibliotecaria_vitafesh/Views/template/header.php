...
<body class="sb-nav-fixed">
    <nav class="sb-topnav navbar navbar-expand navbar-dark bg-primary">
        <a class="navbar-brand" href="<?php echo base_url(); ?>admin/listar">Vitafesh</a>
        ...
        <div id="layoutSidenav_nav">
            <nav class="sb-sidenav accordion sb-sidenav-dark" id="sidenavAccordion">
                ...
                <div class="sb-sidenav-footer bg-primary">
                    <div class="small">Acerca de Vitafesh: </div>
                  <a href="https://sites.google.com/view/proyectovitafesh/inicio-vitafesh" class="text-white"><i class="fas fa-blog"></i> Visita Vitafesh</a>
                </div>
            </nav>
        </div>
